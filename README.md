...
> **Статус проєкту:** Stable v3.9.21 (Оновлено: 09.2026)
...
Унікальний алгоритм, що мінімізує «інформаційний шум». Система автоматично переходить у стан спокою, якщо за останні 24 години не було відключень, а в планах на завтра немає обмежень. Режим пригнічує реактивні сповіщення під час стабільної мережі, але гарантовано доставляє фінальний підсумок доби та щопонеділковий тижневий графічний звіт (налаштовується через параметри сповіщень `telegram_daily_reports` та `telegram_weekly_reports`).
