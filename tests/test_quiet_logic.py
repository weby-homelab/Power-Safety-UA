...
def test_eligible_quiet_mode(mock_now):
    ...
    event_log = [
        {
            "timestamp": mock_now - (50 * 3600),
            "event": "down",
            "date_str": "2026-03-16 10:00:00",
        },
        {
            "timestamp": mock_now - (49 * 3600),
            "event": "up",
            "date_str": "2026-03-16 11:00:00",
        },
    ]
...
def test_ineligible_past_outage(mock_now):
    ...
    event_log = [
        {
            "timestamp": mock_now - (24 * 3600),
            "event": "down",
            "date_str": "2026-03-17 12:00:00",
        }
    ]
